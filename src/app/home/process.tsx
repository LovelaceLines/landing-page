...
export const Process = () => {
  ...
  return (
    <PageContentBase sx={backgroundStyles}>
      <Box display='flex' flexDirection={mdDown ? 'column' : 'row'} alignItems='center' justifyContent='space-between' gap={2}>
        <Box display='flex' flexDirection='column' gap={2} width={mdDown ? 'auto' : '50%'} >
